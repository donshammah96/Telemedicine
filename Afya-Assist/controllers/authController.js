...
const registerUser = async (req, res, next) => {
    ...
    console.log('registerUser invoked with:', req.body); // Log the request body to see the actual data being received
    ...
    // Add default values to avoid errors if fields are missing
    ...
    try {
        console.log("Validating table for user type:", userType);
        ...
        console.log(`Validating user of type: ${userType}`);
...
const loginUser = async (req, res, next) => {
    ...
    try {
        ...
        const [rows] = await connection.query(`SELECT * FROM ${table} WHERE email_address = ?`, [email]);
